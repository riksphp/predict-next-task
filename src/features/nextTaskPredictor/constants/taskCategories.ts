...
// Priority groupings for task selection
export const PRIORITY_GROUPS = {
  PROFESSIONAL_GROWTH: [
    TASK_CATEGORIES.WORK_PRODUCTIVITY,
    TASK_CATEGORIES.LEARNING_GROWTH,
    TASK_CATEGORIES.COMMUNICATION,
    TASK_CATEGORIES.PLANNING_GOALS,
  ],
  PERSONAL_GROWTH: [
    TASK_CATEGORIES.HEALTH_WELLNESS,
    TASK_CATEGORIES.CREATIVITY_EXPRESSION,
    TASK_CATEGORIES.RELATIONSHIPS_COMPASSION,
    TASK_CATEGORIES.ORGANIZATION_RESPONSIBILITY,
    TASK_CATEGORIES.PHYSICAL_ACTIVITY,
    TASK_CATEGORIES.MAINTENANCE_CARE,
  ],
  FOUNDATIONAL: [TASK_CATEGORIES.MINDFULNESS_PRESENCE, TASK_CATEGORIES.REFLECTION_ACCEPTANCE],
} as const;
